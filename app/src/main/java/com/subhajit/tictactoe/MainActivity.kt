package com.subhajit.tictactoe
...
import com.subhajit.tictactoe.ui.theme.TicTacToeTheme
...
Text(
    ...
    modifier = Modifier.padding(16.dp)
        ...
        if (win.value != null){
            ...
            else if (win.value == Win.AI) {
                Text(text = "Ai has Won \uD83D\uDE24", fontSize = 25.sp)
            }
            else if (win.value == Win.DRAW) {
                Text(text = "It has a Draw \uD83D\uDE33", fontSize = 25.sp)
            }
            Button(onClick = {
                playerTurn.value=true
                win.value=null
...
when (move) {
    true -> Image(painter = painterResource(id = R.drawable.close), contentDescription = null,
        modifier = Modifier.fillMaxSize(1f)
    , colorFilter = ColorFilter.tint(Color.Blue)
    )
    false -> Image(painter = painterResource(id = R.drawable.eye), contentDescription = null,
        modifier = Modifier.fillMaxSize(1f)
        , colorFilter = ColorFilter.tint(Color.Red)
    )
    null -> Image(painter = painterResource(id = R.drawable.null_1), contentDescription = null,
        modifier = Modifier.fillMaxSize(1f))
